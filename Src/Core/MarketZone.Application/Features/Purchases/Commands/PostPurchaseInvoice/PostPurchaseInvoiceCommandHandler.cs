...
{
	public class PostPurchaseInvoiceCommandHandler(IPurchaseInvoiceRepository repository, IUnitOfWork unitOfWork, ITranslator translator, IMapper mapper, IInventoryAdjustmentService inventoryAdjustment) : IRequestHandler<PostPurchaseInvoiceCommand, BaseResult>
	{
