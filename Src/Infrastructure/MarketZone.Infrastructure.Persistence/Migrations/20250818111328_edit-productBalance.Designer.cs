...
namespace MarketZone.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250818111328_edit-productBalance")]
    partial class editproductBalance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketZone.Domain.Inventory.Entities.ProductBalance", b =>
                {
                    ...
                    b.HasIndex("ProductId", "IsRoasted")
                        .IsUnique()
                        .HasFilter("[IsRoasted] IS NOT NULL");
