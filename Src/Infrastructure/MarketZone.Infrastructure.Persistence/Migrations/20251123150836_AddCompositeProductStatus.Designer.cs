...
namespace MarketZone.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251123150836_AddCompositeProductStatus")]
    partial class AddCompositeProductStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketZone.Domain.Cash.Entities.ExchangeTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MarketZone.Domain.Cash.Entities.Payment", b =>
                {
                    ...
                    b.Property<decimal?>("AmountInPaymentCurrency")
                        .HasColumnType("decimal(18,6)");
                    ...
                    b.Property<short>("PaymentCurrency")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("MarketZone.Domain.Employees.Entities.Employee", b =>
                {
                    ...
                    b.Property<decimal?>("DollarMoney")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("SyrianMoney")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("MarketZone.Domain.Employees.Entities.EmployeeSalary", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MarketZone.Domain.Employees.Entities.SalaryPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MarketZone.Domain.Employees.Entities.SalaryPayment", b =>
                {
                    b.HasOne("MarketZone.Domain.Cash.Entities.CashRegister", "CashRegister")
                        .WithMany()
